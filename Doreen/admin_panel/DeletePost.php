...
while ($DataRows=$stmt->fetch()) {
  ...
  $ImageToBeDeleted4    = $DataRows['image4'];
  $ImageToBeDeleted5    = $DataRows['image5'];
  $ImageToBeDeleted6    = $DataRows['image6'];
  $ImageToBeDeleted7    = $DataRows['image7'];
...
if(isset($_POST["Submit"])){
    ...
    if($Execute){
      ...
      unlink($Target_Path_To_DELETE_Image3);
            $Target_Path_To_DELETE_Image4 = "../Uploads/$ImageToBeDeleted4";
      unlink($Target_Path_To_DELETE_Image4);
            $Target_Path_To_DELETE_Image5 = "../Uploads/$ImageToBeDeleted5";
      unlink($Target_Path_To_DELETE_Image5);
            $Target_Path_To_DELETE_Image6 = "../Uploads/$ImageToBeDeleted6";
      unlink($Target_Path_To_DELETE_Image6);
            $Target_Path_To_DELETE_Image7 = "../Uploads/$ImageToBeDeleted7";
      unlink($Target_Path_To_DELETE_Image7);
